...
import com.nmssalman.bubbleshowcase.ui.theme.BubbleShowCaseTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BubbleShowCaseBuilder(this) //Activity instance
            .title("Sample Text Here!") //Any title for the bubble view
            .targetView(button) //View to point out
            .show()
    }
}
