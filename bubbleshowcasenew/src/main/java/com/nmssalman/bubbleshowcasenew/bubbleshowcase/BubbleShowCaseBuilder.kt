package com.nmssalman.bubbleshowcasenew
...
class BubbleShowCaseBuilder{
    ...
    fun imageResourceId(resId: Int): BubbleShowCaseBuilder {
        mImage = ContextCompat.getDrawable(mActivity!!.get()!!.applicationContext!!.applicationContext, resId)
        return this
    }
    ...
    fun closeActionImageResourceId(resId: Int): BubbleShowCaseBuilder {
        mCloseAction = ContextCompat.getDrawable(mActivity!!.get()!!.applicationContext!!.applicationContext, resId)
        return this
    }
